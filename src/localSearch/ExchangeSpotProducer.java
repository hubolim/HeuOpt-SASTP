...
/**
 * Produces a neighbor of a given solution in trying to exchange an used spot
 * with an unused spot.
 */
public class ExchangeSpotProducer {
	public ExchangeSpotProducer() {

	}

	/**
	 * Produces a neighbor of a given solution in trying to exchange an used
	 * spot with an unused spot.
	 * 
	 * @param problem
	 ...
	 */
	public SASTPSolution produceExchangeSpotNeighbor(SASTProblem problem,
		...
		// Iterate through the tour and exchange the new spot/method at the
		// position
		int iter = 0;
